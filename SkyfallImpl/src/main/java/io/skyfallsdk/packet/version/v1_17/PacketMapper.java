package io.skyfallsdk.packet.version.v1_17;
...
import io.skyfallsdk.packet.version.v1_17.handshake.HandshakeIn;
import io.skyfallsdk.packet.version.v1_17.handshake.HandshakeInLegacy;
import io.skyfallsdk.packet.version.v1_17.status.StatusInPing;
import io.skyfallsdk.packet.version.v1_17.status.StatusInRequest;
import io.skyfallsdk.packet.version.v1_17.status.StatusOutPong;
import io.skyfallsdk.packet.version.v1_17.status.StatusOutResponse;
...
public class PacketMapper extends NetPacketMapper {
    ...
    public PacketMapper() {
        super(ProtocolVersion.v1_17, io.skyfallsdk.packet.version.v1_16_4.PacketMapper.class);
