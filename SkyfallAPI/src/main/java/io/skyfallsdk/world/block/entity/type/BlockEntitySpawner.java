...
import io.skyfallsdk.world.block.entity.meta.type.BlockEntitySpawnerMetadata;

public interface BlockEntitySpawner<M extends BlockEntitySpawnerMetadata<?>> extends BlockEntity<M> {
}
