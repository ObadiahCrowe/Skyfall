...
import io.skyfallsdk.world.block.entity.meta.type.BlockEntityChestMetadata;

public interface BlockEntityChest<M extends BlockEntityChestMetadata<?>> extends BlockEntity<M> {
}
