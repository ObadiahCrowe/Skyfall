...
import io.skyfallsdk.world.block.entity.meta.type.BlockEntityFurnaceMetadata;

public interface BlockEntityFurnace extends BlockEntity<BlockEntityFurnaceMetadata> {
}
