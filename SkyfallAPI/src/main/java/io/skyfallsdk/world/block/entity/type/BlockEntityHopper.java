...
import io.skyfallsdk.world.block.entity.meta.type.BlockEntityHopperMetadata;

public interface BlockEntityHopper<M extends BlockEntityHopperMetadata<?>> extends BlockEntity<M> {
}
