...
import io.skyfallsdk.world.block.entity.meta.type.BlockEntitySkullMetadata;

public interface BlockEntitySkull<M extends BlockEntitySkullMetadata<?>> extends BlockEntity<M> {
}
