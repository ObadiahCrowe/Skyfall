...
import io.skyfallsdk.world.block.entity.meta.type.BlockEntityEndPortalMetadata;

public interface BlockEntityEndPortal extends BlockEntity<BlockEntityEndPortalMetadata> {
}
